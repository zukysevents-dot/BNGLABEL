...
import { featuredSingle } from "@/data/artists";

export function Featured() {
  const f = featuredSingle;
  return (
    <section className="featured">
      <Reveal className="feat-left">
        <div className="feat-cover">
          {f.cover ? (
            <Cover src={f.cover} alt="Obal aktuálního singlu" fallback="Cover" sizes="50vw" />
          ) : (
            "Cover"
          )}
        </div>
      ...
      <Reveal delay={2} className="feat-right">
        ...
        <div className="feat-platforms">
          <a href={f.spotifyUrl} className="pltf sp" target="_blank" rel="noopener noreferrer">
          ...
          <a href={f.appleMusicUrl} className="pltf" target="_blank" rel="noopener noreferrer">
            Apple Music
          </a>
          <a href={f.youtubeUrl} className="pltf" target="_blank" rel="noopener noreferrer">
            YouTube ↗
          </a>
        </div>
      </Reveal>
