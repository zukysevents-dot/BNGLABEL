...
/**
 * Heraldický znak v heru: tmavé logo + lehoučký růžový neonový obrys přesně na
 * něm (jemně bliká). Při scrollu znak stéká dolů, rozostřuje se a mizí (--p).
 * Při prefers-reduced-motion statické (viz CSS).
 */
